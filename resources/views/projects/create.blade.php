            ...
            <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg p-8">
                ...
                <form action="{{ route('projects.store') }}" method="POST" class="space-y-6">
                    ...
                    <div class="flex flex-col sm:flex-row sm:justify-between space-y-4 sm:space-y-0 mt-6">
                        <a href="{{ route('projects.index') }}" class="w-full sm:w-auto text-center sm:text-left bg-gray-200 hover:bg-gray-300 text-gray-800 px-6 py-2 rounded shadow transition">← Volver al listado</a>
