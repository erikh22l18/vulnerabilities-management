            ...
            <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg p-8">
                ...
                <form action="{{ route('admin.users.update', $user) }}" method="POST" class="space-y-6">
                    ...
                    <div class="border-t border-gray-200 mt-6 pt-6">
                        ...
                        <div>
                            <label for="password" class="block font-medium text-gray-700 mb-1 text-sm">Nueva contraseña</label>
                        ...
                        <div class="mt-4">
                            <label for="password_confirmation" class="block font-medium text-gray-700 mb-1 text-sm">Confirmar nueva contraseña</label>
